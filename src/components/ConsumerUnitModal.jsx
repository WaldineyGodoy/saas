        ...
        <div className="modal-overlay">
            <div className="modal-content" style={{ maxWidth: '900px' }}>
                <div className="modal-header">
                    <h3>{consumerUnit ? 'Editar UC' : 'Nova Unidade Consumidora'}</h3>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    ...
                    <div style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
                        <h4 style={{ borderBottom: '1px solid var(--color-border)', paddingBottom: '0.5rem' }}>Vínculos</h4>
                    </div>
                    ...
                    <div style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
                        <h4 style={{ borderBottom: '1px solid var(--color-border)', paddingBottom: '0.5rem' }}>Dados da Unidade</h4>
                    </div>
                    ...
                    <div style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
                        <h4 style={{ borderBottom: '1px solid var(--color-border)', paddingBottom: '0.5rem' }}>Endereço de Instalação</h4>
                    </div>
                    ...
                    <div style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
                        <h4 style={{ borderBottom: '1px solid var(--color-border)', paddingBottom: '0.5rem' }}>Dados Técnicos e Comerciais</h4>
                    </div>
