    ...
    try {
        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onloadend = async () => {
                ...
                // 1. Upload temporary to storage for WhatsApp
                let waMediaUrl = null;
                try {
                    ...
                    if (!uploadError) {
                        ...
                        if (!signedError) waMediaUrl = signedData.signedUrl;
                    }
                ...
                await supabase.from('crm_history').insert({
                    ...
                    content: `Fatura enviada ao e-mail ${targetEmailForLog} e whatsapp ${targetPhone}${isSandbox ? ' (Modo Sandbox)' : ''}`,
                    metadata: {
